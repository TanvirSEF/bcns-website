...
export const eventsData: EventItem[] = [
  {
    ...
    summary:
      "The CME on \"Brain Malformation, Congenital Myopathy and Neuroinfection: Evaluation & Updated Management\" was held on 17 January 2026 at the Conference Hall, National Institute of Neurosciences and Hospital (NINS), Dhaka, organized by the Bangladesh Child Neurology Society (BCNS). The program commenced with an inaugural session, followed by the introduction of speakers and scientific presentations. Prof. Dr. Mitsuhiro Kato (Japan) delivered a comprehensive lecture on neuroinfection and encephalopathy, emphasizing diagnostic approaches and updated management strategies. Prof. Dr. Hiroya Nishida presented on congenital myopathies, highlighting phenotypic and genotypic correlations, while Prof. Dr. Masashi Ogasawara discussed brain malformations with a focus on neuroimaging and clinical decision-making. Live case discussions and expert panel interactions enriched the academic exchange. The CME highlighted recent advances in pediatric neurology and fostered collaboration between Bangladeshi and Japanese experts. The event significantly contributed to enhancing clinical knowledge, evidence-based practice, and international academic collaboration.",
  },
  {
