...
export function UpcomingEvents() {
  return (
    <section className="w-full bg-linear-to-r from-blue-600 via-blue-700 to-blue-600 text-white py-2 sm:py-3 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-linear-to-r from-blue-600/20 via-blue-700/20 to-blue-600/20"></div>
